...
class PDFStyle
{
    ...
    private final Font _titleFont, _dateFont, _contentFont;
    
    public PDFStyle(int columnCount, float columnMargin, float paragraphSpacing, float imageSpacing, DateFormat dateFormat, Font titleFont, Font dateFont, Font contentFont)
    {
